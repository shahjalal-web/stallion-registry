    ...
    <div className="min-h-screen bg-black flex items-center justify-center p-6">
      <div className="w-full max-w-md bg-zinc-950 border border-zinc-800 p-8 rounded-2xl shadow-2xl">
        ...
        <p className="text-zinc-400 text-sm mb-6">
          Login to manage your stallions and favorites.
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full bg-[#D4AF37] text-black font-bold py-3 rounded-lg hover:bg-[#FFD700] transition"
          >
            Login
          </button>
        </form>
        ...
        <p className="mt-6 text-center text-zinc-500 text-sm">
          Admin Login{" "}
          <Link href="/login/admin" className="text-[#846c1f] hover:underline">
            Admin Login
          </Link>
        </p>
      </div>
